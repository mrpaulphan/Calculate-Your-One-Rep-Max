...
function converter() {
    ...
    calculateBtn.click(function() {
        console.log("clicked");
        var weight = $(".input-weight"), rep = $(".input-rep"), inputWeightValue = parseInt(weight.val()), inputRepsValue = parseInt(rep.val()), resultPercentage = $("td").attr("data-weight-percentage");
        if (weight.length <= 1) {
            weight.val(0);
        }
        if (rep.length <= 1) {
        ...
        if ($("#forumula option:selected").val() == "epleyFormula") {
            ...
            var oneRepMaxFormula = 100 * inputWeightValue / (101.3 - 2.67123 * inputRepsValue);
        }
        console.log(weight);
        $('span[data-weight-percentage="100"]').text(Math.round(oneRepMaxFormula));
        $('td[data-weight-percentage="95"]').text(Math.round(oneRepMaxFormula * .95));
        $('td[data-weight-percentage="90"]').text(Math.round(oneRepMaxFormula * .9));
        $('td[data-weight-percentage="85"]').text(Math.round(oneRepMaxFormula * .85));
        $('td[data-weight-percentage="80"]').text(Math.round(oneRepMaxFormula * .8));
        $('td[data-weight-percentage="75"]').text(Math.round(oneRepMaxFormula * .75));
        $('td[data-weight-percentage="70"]').text(Math.round(oneRepMaxFormula * .7));
        $('td[data-weight-percentage="65"]').text(Math.round(oneRepMaxFormula * .65));
        $('td[data-weight-percentage="60"]').text(Math.round(oneRepMaxFormula * .6));
        $(".count").each(function() {
